...
replace (
	...
	github.com/hashicorp/vault => flant.internal/deckhouse/stronghold.git/images/stronghold v1.18.6
	github.com/hashicorp/vault/api => flant.internal/deckhouse/stronghold.git/images/stronghold/api v1.18.6
