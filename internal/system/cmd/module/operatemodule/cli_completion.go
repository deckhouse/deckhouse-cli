...
func CompleteForApprove(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
	return completeModuleReleaseAndVersion(cmd, args, toComplete, CanBeApproved)
}
...
func CompleteForApplyNow(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
	return completeModuleReleaseAndVersion(cmd, args, toComplete, CanBeAppliedNow)
}
...
func completeModuleReleaseAndVersion(cmd *cobra.Command, args []string, toComplete string, match ReleaseMatchFunc) ([]string, cobra.ShellCompDirective) {
