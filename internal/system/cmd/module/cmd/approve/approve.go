...
func approveRelease(cmd *cobra.Command, args []string) error {
	...
	if err != nil {
		if errors.IsNotFound(err) {
			return cli.SuggestSuitableReleasesOnNotFound(dynamicClient, moduleName, version, module_releases.CanBeApproved)
		}
	...
	err = module_releases.ApproveModuleRelease(dynamicClient, release.Name)
	if err != nil {
