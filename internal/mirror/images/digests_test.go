...
func createEmptyImageLayout(t *testing.T, path string) layout.Path {
	...
	require.NoError(t, os.MkdirAll(blobsPath, 0755))
	require.NoError(t, os.WriteFile(indexFilePath, indexContents, 0644))
	require.NoError(t, os.WriteFile(layoutFilePath, layoutContents, 0644))
